...
const discordAuth = () => {
    window.open(
        `https://discord.com/api/oauth2/authorize?client_id=871148961191297074&redirect_uri=https%3A%2F%2Fgdscnuv.herokuapp.com%2Fapply&response_type=code&scope=identify`,
        "_parent"
    );
    auth.login();
}

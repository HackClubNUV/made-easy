    ...
    <>
      ...
      <Container maxW="container.lg" paddingY="10" marginTop="4" centerContent>
        <Text fontSize={{ base: '2xl', md: '4xl' }} fontWeight="bold">
          Hi {username.length > 0 ? username + '!' : 'there!'}
        </Text>
        <Container
          maxW="container.lg"
        ...
        >
          <Text textAlign={{ base: 'justify', md: 'center' }}>
            We are happy to see you consider joining{' '}
            <b>Google Developer Student Clubs NUV!</b> We have tailored this
            process with the help of <b>Hack Club NUV</b> in such way, that its
            easy for both the new members and the existing members to get to
            know each other and work well together. Our primary goal is to help
            the community and learn new things along the way! Get started with
            your application process by filling the application form linked
            below :)
          </Text>
        </Container>
        <Link
          href={
            data[0].done ? null : 'https://s684h2u3rzr.typeform.com/to/NRmubCZ0'
          }
          isExternal
          target="_blank"
        >
